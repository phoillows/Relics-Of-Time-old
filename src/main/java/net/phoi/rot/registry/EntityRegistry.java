...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<Shringasaurus>> SHRINGASAURUS = register("shringasaurus", EntityType.Builder.of(Shringasaurus::new, MobCategory.CREATURE).sized(0.9F, 1.0F));
